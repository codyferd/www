...
<div class="sr-only">
	...
	<p>
		Designed to be clean, responsive, and user-friendly, Avero provides a modular suite of web
		applets including Avero Blocks.
	</p>
</div>

<div class="min-h-screen bg-[#020205] font-sans text-[#f8fafc] selection:bg-indigo-500/40">
	<main>
		{@render children()}
	</main>
</div>
